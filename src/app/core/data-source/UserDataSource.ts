...
export class UserDataSource extends DataSource<UserDetails> {
  ...
  connect(): Observable<UserDetails[]> {
    ...
    this.idSucursal ? this.exampleDatabase.getAllUsersByIdBranch(this.idSucursal!) : this.exampleDatabase.getAllUsers(this.businessGroupId!);
