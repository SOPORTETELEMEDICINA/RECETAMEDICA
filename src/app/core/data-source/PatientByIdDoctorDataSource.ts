...
export class PatientByIdDoctorDataSource extends DataSource<Patient> {
  filterChange = new BehaviorSubject('');
  filteredData: Patient[] = [];
  renderedData: Patient[] = [];

  constructor(
    public idMedico: string | null,
  ...
  connect() {
    ...
    this.exampleDatabase.getAllPatientsbyIdDoctor(this.idMedico!);
