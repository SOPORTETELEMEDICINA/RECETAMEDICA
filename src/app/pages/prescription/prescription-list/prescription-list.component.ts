...
import { PrescriptionEditCreateComponent } from './prescription-edit-create/prescription-edit-create.component';
...
export class PrescriptionListComponent {
  ...
  openUserModal() {
    this.dialogModel.open(PrescriptionEditCreateComponent, {
      width: '640px',
      disableClose: true,
    });
  }
