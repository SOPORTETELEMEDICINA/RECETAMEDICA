...
import {PatientByIdBranch} from "@core/data-source/PatientByIdBranch";

@Component({
  selector: 'app-patient-by-branch',
  standalone: true,
  imports: [
    MatTooltipModule,
    MatButtonModule,
  ...
  templateUrl: './patient-by-branch.component.html',
  styleUrl: './patient-by-branch.component.scss'
})
export class PatientByBranchComponent
  ...
  public loadData() {
    ...
    this.dataSource = new PatientByIdBranch(
      this.idBranch,
      this.data,
      this.paginator,
      this.sort
